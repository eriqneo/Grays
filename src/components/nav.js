      ...
      <div class="max-w-6xl px-2 py-4">
          <div class="flex justify-between">
              <div class="hidden md:flex space-x-3 whitespace-nowrap">
                  <div>
                      ...
                      <a href="/src/gallery.html" class="py-4 px-1 text-gray-300 text-xl font-semibold hover:text-white hover:border-b-2 transition duration-300">Gallery</a>
          ...
          <div class="md:hidden mobile-menu block">
              <ul class="">
				  ...
				  <li><a href="/src/about.html" class="block py-4 px-2 text-gray-300 text-sm font-semibold hover:text-white hover:border-b-2 transition duration-300">About Us</a></li>
				  <li><a href="/src/services.html" class="block py-4 px-2 text-gray-300 text-sm font-semibold hover:text-white hover:border-b-2 transition duration-300">0ur Services</a></li>
				  <li><a href="/src/clinics.html" class="block py-4 px-2 text-gray-300 text-sm font-semibold hover:text-white hover:border-b-2 transition duration-300">Special Clinics</a></li>
                  <li><a href="/src/gallery.html" class="block py-4 px-2 text-gray-300 text-sm font-semibold hover:text-white hover:border-b-2 transition duration-300">Gallery</a></li>
                  <li><a href="/src/contact.html" class="block py-4 px-2 mb-2 text-gray-300 text-sm font-semibold hover:text-white hover:border-b-2 transition duration-300">Book Appointment</a></li>
              </ul>
          </div>
      </div>
</nav>
